...
function InviteListBox({ invitations }: { invitations: InvitationsDashboardGet }) {
	...
	const a = 3;
	return (
		<div className='ml-[2rem] flex h-fit w-[62rem] flex-shrink-0 flex-col rounded-[0.8rem] bg-white p-[2.8rem] pb-[2rem]'>
			<div className='mb-[2.7rem] flex items-center justify-between'>
				...
				<div className='flex items-center gap-[1.6rem]'>
					...
					<Button color='violet' variant='confirm' className='w-[10.5rem] px-[1.6rem] py-[0.8rem]'>
						<div className='flex h-fit flex-shrink-0 gap-[0.8rem]'>
