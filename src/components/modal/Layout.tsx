...
function Layout({ children, $modalType, isOpen, setOpen }: LayoutProps) {
	if (!isOpen) return null;
	const modalType = {
		Alert:
			'flex h-[25rem] w-[54rem] justify-center rounded-lg bg-white px-[2.8rem] pt-[10.8rem] sm:h-[22rem] sm:w-[32.7rem] sm:pt-[8.1rem]',
		Modal:
